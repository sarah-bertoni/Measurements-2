...
threshw<-c("2 to 9.6 kg", "6.5 to 12.5 kg", "8.8 to 14.9 kg", "10.8 to 18.1 kg")
thresholds<-data.frame("Age" = ages, "Normal weights" = threshw)
kable(thresholds, caption="Expected weights of children in West Africa")


nutri_kg <- nutri %>%
  mutate(weightkg = case_when(
    year == "2008" & age <= 12 & weightkg > 9.6 ~ weightkg * 0.1,
    year == "2008" & age <= 12 ~ weightkg,
    year == "2008" & age > 12 & age <= 24 & weightkg > 12.5 ~ weightkg * 0.1,
    year == "2008" & age > 12 & age <= 24 ~ weightkg,
    year == "2008" & age > 24 & age <= 36 & weightkg > 14.9 ~ weightkg * 0.1,
    year == "2008" & age > 24 & age <= 36 ~ weightkg,
    year == "2008" & age > 36 & weightkg > 18.1 ~ weightkg * 0.1,
